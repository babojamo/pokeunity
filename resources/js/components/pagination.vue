    ...
    <nav class="Page navigation example">
        <ul class="pagination" >
            ...
            <template v-for="(page,key) in pages">
                <li :class="[pageClass, page.disabled ? disabledClass : '', page.breakView ? breakViewClass: '']"
                    :key="key">
                    <a v-if="page.breakView"
                        :class="[pageLinkClass, breakViewLinkClass,page.selected ? activeClass : '']" tabindex="0">
                        <slot name="breakViewContent">{{ breakViewText }}</slot>
                    </a>
                    <a v-else-if="page.disabled" :class="[pageLinkClass,page.selected ? activeClass : '']"
